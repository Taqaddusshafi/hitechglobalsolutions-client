        ...
        <div>
            ...
            {loading ? (
                ...
                <div className="text-center py-12 bg-card rounded-lg border border-border">
                    ...
                    <Link to="/admin/portfolio/new" className="text-[#0063cd] hover:underline mt-2 inline-block">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {filteredProjects.map((project, index) => (
                        ...
                        >
                            {/* Cover Image */}
                            <div className={`h-32 bg-gradient-to-br ${project.gradient || 'from-blue-500 to-purple-600'} relative overflow-hidden`}>
                                {project.cover_image && (
                                    <img
                            ...
                            <div className="p-4">
                                <div className="flex items-start justify-between mb-2">
                                    <div>
                                        ...
                                        <span className="text-xs text-[#0063cd] bg-[#0063cd]/10 px-2 py-0.5 rounded-full">
                                            {project.category}
                                        </span>
                                    </div>
                                    {project.featured && (
                                ...
                                <div className="flex items-center gap-1 mt-4">
                                    ...
                                    <Link to={`/admin/portfolio/${project.id}`} className="flex-1">
                                        <button className="w-full p-2 bg-[#0063cd]/10 text-[#0063cd] rounded-lg hover:bg-[#0063cd]/20 transition-colors">
