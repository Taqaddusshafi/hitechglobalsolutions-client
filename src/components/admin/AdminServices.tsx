        ...
        <div>
            ...
            {loading ? (
                ...
                <div className="text-center py-12 bg-card rounded-lg border border-border">
                    ...
                    <Link to="/admin/services/new" className="text-[#0063cd] hover:underline mt-2 inline-block">
                        ...
                        >
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <Link to={`/admin/services/${service.id}`}>
                                    <button className="p-2 bg-[#0063cd]/10 text-[#0063cd] rounded-lg hover:bg-[#0063cd]/20 transition-colors">
