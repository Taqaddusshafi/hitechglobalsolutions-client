                                    ...
                                    >
                                        <div className="flex items-start justify-between gap-3">
                                            <div className="flex-1 min-w-0">
                                                <h4 className="font-medium text-foreground truncate group-hover:text-[#0063cd] transition-colors">
                                                    {blog.title}
                                                </h4>
                                                ...
                                                <div className="flex items-center gap-2 mt-2">
                                                    <span className="text-xs bg-[#0063cd]/10 text-[#0063cd] px-2 py-0.5 rounded-full">
                                                        {blog.category}
                                                    </span>
                                                </div>
                                            </div>
                                            <ArrowRight className="w-4 h-4 text-muted-foreground group-hover:text-[#0063cd] transition-colors flex-shrink-0 mt-1" />
                                        </div>
                                    </Link>
                                ))}
                            </div>
